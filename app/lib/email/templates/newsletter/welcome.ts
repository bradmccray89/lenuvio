                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              ...
                              <td style="vertical-align: top;">
                                ...
                                <p style="color: #cbd5e1; font-size: 15px; margin: 0; line-height: 1.5; font-family: Arial, Helvetica, sans-serif;">You'll receive occasional updates about new projects, technical insights, and industry trends. No spam, just valuable content when I have something worth sharing.</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              <td style="padding: 25px 25px 10px 25px;">
                                <h3 style="color: #f1f5f9; font-size: 18px; font-weight: bold; margin: 0; font-family: Arial, Helvetica, sans-serif;">Coming Up</h3>
                              </td>
                            </tr>
                          </table>
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                              <td style="padding: 18px 25px;">
                                ...
                                <p style="color: #f1f5f9; font-size: 15px; margin: 0; font-family: Arial, Helvetica, sans-serif;">Useful resources, tools, and techniques I discover along the way</p>
                              </td>
                            </tr>
                          </table>
                      ...
                      <tr>
                        <td style="text-align: center; margin: 25px 0;">
                          ...
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://lenuv.io" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="17%" stroke="f" fillcolor="#06b6d4">
                            <w:anchorlock/>
                            <center style="color:#ffffff;font-family:Arial, sans-serif;font-size:16px;font-weight:bold;">View Portfolio</center>
                          </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-->
                          ...
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://lenuv.io#contact" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="17%" stroke="f" fillcolor="#06b6d4">
                            <w:anchorlock/>
                            <center style="color:#ffffff;font-family:Arial, sans-serif;font-size:16px;font-weight:bold;">Start a Project</center>
                          </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-->
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
                        <td style="padding: 20px 0;">
                          ...
                          <p class="email-text" style="color: #e2e8f0; font-size: 16px; line-height: 1.6; margin: 0 0 25px 0; font-family: Arial, Helvetica, sans-serif;">
                            Best regards,<br>
                            <strong style="color: #f1f5f9;">Brandon McCray</strong><br>
                      ...
                      <tr>
                        <td style="text-align: center;">
                          ...
                          <p style="color: #71717a; font-size: 12px; margin: 20px 0 0 0; font-family: Arial, Helvetica, sans-serif;">
                            Subscribed on ${new Date().toLocaleDateString(
                              'en-US',
                              {
                                year: 'numeric',
                                month: 'long',
